...
seed = 66
pos = 0
param_n_estimators = [200, 200]
param_max_depth = [8, 12]
param_max_features = ['auto', 'auto']
param_criterion = ['gini', 'gini']
param_min_samples_leaf = [2, 1]
...
clf = RandomForestClassifier(n_estimators=param_n_estimators[pos],
